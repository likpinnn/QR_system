                ...
                <div class="col-md-12 content-section header-section">
                    <table class="table table-bordered border-dark">
                        <tr class="row text-center border-dark border-2 border">
                            <td class="col-md-3">
                                <img src="<?php echo $logo; ?>" alt="Logo" style="max-height: 40px; max-width: 100%;">
                            </td>
                            <td class="col-md-6">
                                <h6><?=$report_name?></h6>
                            </td>
                        ...
                        <div class="col-md-12 px-5">
                            <table>
                                <tr>
                                    ...
                                    <td style="width: 80%;"><?=$tools?></td>
                                </tr>
                                <tr>
                                    <td style="width: 20%;">Reference Document</td>
                                    <td style="width: 80%;"><?=$reference_document?></td>
                                </tr>                           
                            </table>
                        </div>
                    </div>
                ...
                <div class="col-md-12 content-section mb-2">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><?=$date_completed?></td>
                        </tr>
                    </table>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="<?php 
                                        ...
                                        if (preg_match('/^([<>=]+)(.+)$/', $spec, $matches)) {
                                            ...
                                            switch($operator) {
                                                case '>':
                                                    echo $result_num > $spec_num ? 'background-color: #90EE90;' : 'background-color: #FFB6C1;';
                                                    break;
                                                case '>=':
                                                    echo $result_num >= $spec_num ? 'background-color: #90EE90;' : 'background-color: #FFB6C1;';
                                                    break;
                                            ...
                                            // 如果没有比较运算符，直接比较字符串
                                            echo strtolower($result) === strtolower($spec) ? 'background-color: #90EE90;' : 'background-color: #FFB6C1;';
                                        }
                                        ?>">
                                        <?php 
                                        // 移除所有空格以便比较
                                ...
                                foreach($final as $step){
                                    ...
                                    foreach($step as $s){
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$action?></td>
                                            <?php if($result == 'Pass'){ ?>
                                                <td class="text-center" style="background-color: #90EE90;">
                                                    Pass
                                                </td>
                                            <?php }else{ ?>
                                                <td class="text-center" style="background-color: #FFB6C1;">
                                                    Fail
                                                </td>
                                            <?php }?>
